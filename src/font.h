...
// A simple 8x8 bitmap font (public domain).
// Each char is 8 bytes, where each bit represents a pixel.
static const unsigned char font[128][8] = {
    ...
    {0x00, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // U+001F
    ...
    {0x3C, 0x66, 0x3C, 0x36, 0x66, 0x3C, 0x00, 0x00}, // U+0026 (&)
    ...
    {0x7E, 0x60, 0x60, 0x7C, 0x06, 0x06, 0x7C, 0x00}, // U+0035 (5)
    ...
    {0x3C, 0x66, 0x6E, 0x6A, 0x6E, 0x60, 0x3C, 0x00}, // U+0040 (@)
    {0x7C, 0x66, 0x66, 0x7C, 0x66, 0x66, 0x66, 0x00}, // U+0041 (A)
    ...
    {0x66, 0x66, 0xE6, 0xF6, 0xDE, 0xCE, 0x66, 0x00}, // U+004E (N)
    {0x3C, 0x66, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x00}, // U+004F (O)
    {0x7C, 0x66, 0x66, 0x7C, 0x60, 0x60, 0x60, 0x00}, // U+0050 (P)
    {0x3C, 0x66, 0x66, 0x66, 0x66, 0x6A, 0x3C, 0x0C}, // U+0051 (Q)
    ...
    {0x00, 0x00, 0x7C, 0x6E, 0x60, 0x60, 0x60, 0x00}, // U+0072 (r)
    {0x00, 0x00, 0x3E, 0x60, 0x3C, 0x06, 0x7C, 0x00}, // U+0073 (s)
    {0x10, 0x3C, 0x10, 0x10, 0x10, 0x16, 0x0C, 0x00}, // U+0074 (t)
